...
\begin{document}
    ...
    \subsection{平动参考系中谐振子的波函数与Wigner函数}
        ...
        说明在S'系观察者看来，谐振子基态是一个运动的Gauss波包，其中心位置$-\zeta(t)$正是平动参考系的原点的位置，动量的中心值$-m\frac{d\zeta}{dt}$也正是平动参考系带来的额外的动量。


    \subsection{实验室参考系下的平动谐振子}
        经典力学层面，平动参考系下的一个无平动自由度的谐振子，其运动学等价于静止参考系下的一个平动谐振子。因此我们在量子力学层面可以猜想，
