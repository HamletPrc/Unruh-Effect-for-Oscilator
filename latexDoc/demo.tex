...
\begin{document}
    ...
    \subsection{Ehrenfest定理以及狭义量子达朗贝尔原理}
        ...
        惯性势$\hat{V}_{iner}$中的动量项$-\frac{d\zeta}{dt}\hat{p}$则应当与Hamilton量中的动能项$\frac{\hat{p}^2}{2m}$进行配平方，得到$\frac{\big(\hat{p}-m\frac{d\zeta}{dt}\big)^2}{2m}-\frac{1}{2}m\big(\frac{d\zeta}{dt}\big)$。第一项也是符合经典物理图像的，它代表了在S'系中观测物体运动，其动量会有$-m\frac{d\zeta}{dt}$的变化。第二项与$V_{iner}$中的$\frac{1}{2}m\big(\frac{d\zeta}{dt}\big)^2$合并，给出一个全局相位。
